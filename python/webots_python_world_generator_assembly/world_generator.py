...
def main():
	...
	'''
	worldfile = "world_5puzzles";
	builder = worldbuilder.WorldBuilder(worldfile + ".wbt", "header.wbtt", None, "templates/");
	handler = worldhandler.WorldHandler(worldfile + ".xml", builder);
	handler.parse();
